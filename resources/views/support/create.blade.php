        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('support.store') }}">
                    ...
                    <div class="mb-3"><label>Тип</label><select name="type" class="form-control" required><option value="payment">Оплата</option><option value="consultation">Консультация</option><option value="complaint">Жалоба</option><option value="other">Другое</option></select></div>
