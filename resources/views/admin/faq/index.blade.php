...
@section('content')
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle">
            ...
            @forelse($articles as $article)
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('admin.faq.destroy', $article) }}" method="POST" class="d-inline" onsubmit="return confirm('Удалить статью?')">
                            @csrf
                            @method('DELETE')
            ...
            @empty
                <tr><td colspan="5" class="text-center">Нет статей</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
