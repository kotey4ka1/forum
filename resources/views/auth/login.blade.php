            ...
            <div class="col-md-6 col-lg-5">
                <div class="card border-0 shadow-lg rounded-4">
                    <div class="card-header bg-white border-0 pt-4 pb-0 text-center">
                        <h3 class="fw-bold mb-0">Вход в аккаунт</h3>
                        <p class="text-muted mt-2">Добро пожаловать! Введите свои данные</p>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            {{-- Кнопка входа и ссылка на восстановление пароля --}}
                            ...
                            <div class="text-center mt-4">
                                ...
                                <a href="{{ route('register') }}" class="text-decoration-none ms-1 fw-semibold">Зарегистрироваться</a>
                            </div>
                        </form>
                    </div>
                </div>
